...
Namespace PayrollSettings.Presenters
    ...
    ' Ginagamit ito ng 2 instances (Deduction, Bonus) - tableName na-inject
    ' sa constructor, gaya ng LookupPresenter.
    Public Class PayrollFlaggedEntryPresenter

        Private ReadOnly _view As Views.IPayrollFlaggedEntryMaintenanceView
        Private ReadOnly _service As Services.IPayrollFlaggedEntryService
        Private ReadOnly _tableName As String
        Private ReadOnly _userName As String

        Private _selectedId As Integer = 0
        Private _isNewMode As Boolean = False
        Private _currentList As List(Of PayrollFlaggedEntryModel)

        Public Sub New(
            view As Views.IPayrollFlaggedEntryMaintenanceView,
            service As Services.IPayrollFlaggedEntryService,
            tableName As String,
            userName As String)
        ...
        Public Async Function SaveAsync() As Task
            Dim item As New PayrollFlaggedEntryModel With {
                .Id = _selectedId,
