    ...
    Public Class StatutorySettingsPresenter
        ...
        Public Async Function ImportFromExcelAsync(filePath As String) As Task
            ...
            Catch ex As Exception
                _view.ShowError($"The file cannot be opened: {ex.Message}")
                Return
            End Try

            If rows.Count = 0 Then
                _view.ShowError("An empty row was read from the Excel file.")
                Return
            End If
        ...
        Public Async Function ExportToExcelAsync(filePath As String, sheetLabel As String) As Task
            ...
            Try
                ...
                _view.ShowMessage($"Exported to: {filePath}")
            Catch ex As Exception
                _view.ShowError($"Cannot be exported: {ex.Message}")
            End Try
