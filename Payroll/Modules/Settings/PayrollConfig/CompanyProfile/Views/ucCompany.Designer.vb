...
Partial Class ucCompany
    ...
    Private Sub InitializeComponent()
        ...
        lblTabPageTitle.Size = New Size(220, 30)
        ...
        grpDetails.Size = New Size(861, 400)
        grpDetails.TabIndex = 2
        grpDetails.Text = " COMPANY INFORMATION"
        '
        ' Column 1 (x=24): Company Code, Company Name, Industry, SEC Registration No.
        '
        lblCompanyCode.Location = New Point(24, 34)
        lblCompanyCode.Name = "lblCompanyCode"
        lblCompanyCode.Size = New Size(66, 13)
        ...
        lblCompanyName.Size = New Size(70, 13)
        ...
        lblIndustry.Size = New Size(39, 13)
        ...
        lblSECRegistrationNo.Size = New Size(93, 13)
        ...
        '
        ' Column 2 (x=280): Address 1-3, Website
        '
        ...
        lblWebsite.Size = New Size(40, 13)
        ...
        '
        ' Column 3 (x=536): Country, Post Code, Telephone No., Fax No.
        '
        ...
        '
        ' Column 4 (x=792): Contact Person (LookUpEdit), Position (read-only), Email, Active
        '
        ...
        lookupContactPerson.Location = New Point(792, 52)
