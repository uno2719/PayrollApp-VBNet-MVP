...
Partial Class ucLeaveType
    ...
    Private Sub InitializeComponent()
        ...
        gridconLeaveTypeList = New DevExpress.XtraGrid.GridControl()
        gridviewLeaveTypeList = New DevExpress.XtraGrid.Views.Grid.GridView()
        ...
        CType(cboCategory.Properties, ComponentModel.ISupportInitialize).BeginInit()
        CType(txtCode.Properties, ComponentModel.ISupportInitialize).BeginInit()
        CType(gridconLeaveTypeList, ComponentModel.ISupportInitialize).BeginInit()
        CType(gridviewLeaveTypeList, ComponentModel.ISupportInitialize).BeginInit()
        SuspendLayout()
        ' 
        ' PanelControl1
        ' 
        ...
        lblTabPageTitle.Size = New Size(48, 28)
        lblTabPageTitle.TabIndex = 2
        lblTabPageTitle.Text = "TYPE"
        ' 
        ' wbpMainCommands
        ' 
        ...
        ' chkActive
        ' 
        chkActive.Location = New Point(820, 50)
        ...
        ' txtName
        ' 
        txtName.Location = New Point(380, 50)
        txtName.Margin = New Padding(3, 2, 3, 2)
        txtName.Name = "txtName"
        txtName.Properties.CharacterCasing = CharacterCasing.Upper
        txtName.Properties.NullValuePrompt = "e.g. Vacation Leave"
        txtName.Size = New Size(420, 20)
        txtName.TabIndex = 5
        ' 
        ' lblName
        ' 
        lblName.Location = New Point(380, 32)
        ...
        ' cboCategory
        ' 
        cboCategory.Location = New Point(200, 50)
        ...
        cboCategory.Size = New Size(150, 20)
        cboCategory.TabIndex = 3
        ' 
        ' lblCategory
        ' 
        lblCategory.Location = New Point(200, 32)
        lblCategory.Margin = New Padding(3, 2, 3, 2)
        lblCategory.Name = "lblCategory"
        lblCategory.Size = New Size(47, 13)
        ...
        txtCode.Properties.NullValuePrompt = "e.g. VL"
        ...
        lblCode.Text = "Code"
        ' 
        ' gridconLeaveTypeList
        ' 
        gridconLeaveTypeList.Dock = DockStyle.Fill
        gridconLeaveTypeList.Location = New Point(4, 170)
        gridconLeaveTypeList.MainView = gridviewLeaveTypeList
        gridconLeaveTypeList.Margin = New Padding(3, 2, 3, 2)
        gridconLeaveTypeList.Name = "gridconLeaveTypeList"
        gridconLeaveTypeList.Size = New Size(948, 360)
        gridconLeaveTypeList.TabIndex = 2
        gridconLeaveTypeList.ViewCollection.AddRange(New DevExpress.XtraGrid.Views.Base.BaseView() {gridviewLeaveTypeList})
        ' 
        ' gridviewLeaveTypeList
        ' 
        gridviewLeaveTypeList.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {colCode, colCategory, colName, colActive})
        gridviewLeaveTypeList.GridControl = gridconLeaveTypeList
        gridviewLeaveTypeList.Name = "gridviewLeaveTypeList"
        gridviewLeaveTypeList.OptionsPrint.PrintFilterInfo = True
        gridviewLeaveTypeList.OptionsView.NewItemRowPosition = DevExpress.XtraGrid.Views.Grid.NewItemRowPosition.Top
        gridviewLeaveTypeList.OptionsView.ShowGroupPanel = False
        ' 
        ' colCode
        ' 
        ...
        Controls.Add(gridconLeaveTypeList)
        ...
        CType(cboCategory.Properties, ComponentModel.ISupportInitialize).EndInit()
        CType(txtCode.Properties, ComponentModel.ISupportInitialize).EndInit()
        CType(gridconLeaveTypeList, ComponentModel.ISupportInitialize).EndInit()
        CType(gridviewLeaveTypeList, ComponentModel.ISupportInitialize).EndInit()
        ResumeLayout(False)
    End Sub
    ...
    Friend WithEvents gridconLeaveTypeList As DevExpress.XtraGrid.GridControl
    Friend WithEvents gridviewLeaveTypeList As DevExpress.XtraGrid.Views.Grid.GridView
