...
Namespace PayrollSettings.Presenters
    ...
    Public Class PayrollRateEntryPresenter

        Private ReadOnly _view As Views.IPayrollRateEntryMaintenanceView
        Private ReadOnly _service As Services.IPayrollRateEntryService
        Private ReadOnly _tableName As String
        Private ReadOnly _userName As String

        Private _selectedId As Integer = 0
        Private _isNewMode As Boolean = False
        Private _currentList As List(Of PayrollRateEntryModel)

        Public Sub New(
            view As Views.IPayrollRateEntryMaintenanceView,
            service As Services.IPayrollRateEntryService,
            tableName As String,
            userName As String)
        ...
        Public Async Function SaveAsync() As Task
            Dim item As New PayrollRateEntryModel With {
                .Id = _selectedId,
