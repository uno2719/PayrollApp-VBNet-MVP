...
Partial Class ucLoan
    ...
    Private Sub InitializeComponent()
        ...
        cboLoanType = New DevExpress.XtraEditors.ComboBoxEdit()
        lblLoanType = New DevExpress.XtraEditors.LabelControl()
        ...
        colLoanType = New DevExpress.XtraGrid.Columns.GridColumn()
        ...
        CType(cboLoanType.Properties, ComponentModel.ISupportInitialize).BeginInit()
        ...
        grpDetails.Controls.Add(cboLoanType)
        grpDetails.Controls.Add(lblLoanType)
        ...
        ' cboLoanType
        ' 
        cboLoanType.Location = New Point(24, 99)
        cboLoanType.Margin = New Padding(3, 2, 3, 2)
        cboLoanType.Name = "cboLoanType"
        cboLoanType.Properties.TextEditStyle = DevExpress.XtraEditors.Controls.TextEditStyles.DisableTextEditor
        cboLoanType.Size = New Size(200, 20)
        cboLoanType.TabIndex = 4
        ' 
        ' lblLoanType
        ' 
        lblLoanType.Location = New Point(24, 81)
        lblLoanType.Margin = New Padding(3, 2, 3, 2)
        lblLoanType.Name = "lblLoanType"
        lblLoanType.Size = New Size(56, 13)
        lblLoanType.TabIndex = 3
        ...
        txtDescription.Properties.NullValuePrompt = "e.g. Equicom Salary Loan"
        ...
        txtCode.Properties.NullValuePrompt = "e.g. BANK1"
        ...
        gridconLoanList.Location = New Point(4, 224)
        gridconLoanList.MainView = gridviewLoanList
        gridconLoanList.Margin = New Padding(3, 2, 3, 2)
        gridconLoanList.Name = "gridconLoanList"
        gridconLoanList.Size = New Size(948, 306)
        gridconLoanList.TabIndex = 2
        gridconLoanList.ViewCollection.AddRange(New DevExpress.XtraGrid.Views.Base.BaseView() {gridviewLoanList})
        ' 
        ' gridviewLoanList
        ' 
        gridviewLoanList.Columns.AddRange(New DevExpress.XtraGrid.Columns.GridColumn() {colCode, colDescription, colLoanType, colActive})
        gridviewLoanList.GridControl = gridconLoanList
        gridviewLoanList.Name = "gridviewLoanList"
        gridviewLoanList.OptionsPrint.PrintFilterInfo = True
        gridviewLoanList.OptionsView.NewItemRowPosition = DevExpress.XtraGrid.Views.Grid.NewItemRowPosition.Top
        ...
        ' colLoanType
        ' 
        colLoanType.Caption = "Loan Type"
        colLoanType.FieldName = "LoanType"
        colLoanType.Name = "colLoanType"
        colLoanType.Visible = True
        colLoanType.VisibleIndex = 2
        colLoanType.Width = 150
        ' 
        ' colActive
        ' 
        ...
        CType(cboLoanType.Properties, ComponentModel.ISupportInitialize).EndInit()
    ...
    Friend WithEvents cboLoanType As DevExpress.XtraEditors.ComboBoxEdit
    Friend WithEvents lblLoanType As DevExpress.XtraEditors.LabelControl
    ...
    Friend WithEvents colLoanType As DevExpress.XtraGrid.Columns.GridColumn
